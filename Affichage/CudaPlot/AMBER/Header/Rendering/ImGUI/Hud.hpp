...
namespace Ge
{
	...
	public:
		...
		FontData * createFont(const char* filename, float size_pixels, const ImFontConfig* font_cfg = NULL, const ImWchar* glyph_ranges = NULL);
		void destroyFont(FontData * font);
