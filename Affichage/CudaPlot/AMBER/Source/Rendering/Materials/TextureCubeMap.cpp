...
namespace Ge
{
	TextureCubeMap::TextureCubeMap(const std::vector<unsigned char *> & pc, int Width, int Height, int ind,bool filter, VulkanMisc * vM)
	{
		index = ind;
	...
	int TextureCubeMap::getIndex() const
	{
		return index;
	}

	VkImageView TextureCubeMap::getVkImageView() const
	{
		return textureImageView;
	}

	VkSampler TextureCubeMap::getVkSampler() const
	{
